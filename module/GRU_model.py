...
## All functions in this file are taken from GRU training notebook and are described in detail there.
...
## Model parameters -- Taken from the GRU Training notebook
